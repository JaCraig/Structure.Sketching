...
namespace Structure.Sketching.Tests.Formats.Png.Format
{
    public class Header
    {
        ...
        public void Create()
        {
            var TestObject = new Structure.Sketching.Formats.Png.Format.Header(100, 101, 8, 8, 8, 7, 7);
            Assert.Equal(8, TestObject.BitDepth);
            Assert.Equal(8, TestObject.ColorType);
        ...
        {
            byte[] data = { 0, 0, 0, 100, 0, 0, 0, 101, 8, 8, 8, 7, 7 };
