...
namespace Structure.Sketching.Tests.Filters.ColorMatrix
{
    public class Filters : FilterTestBaseClass
    {
        ...
        public static readonly TheoryData<string, IFilter, Rectangle> ColorMatrixFilters = new TheoryData<string, IFilter, Rectangle>
        {
            ...
            { "ResizeCanva-UpperLeft-100x100", new ResizeCanvas(100,100),default(Rectangle) },
            { "ResizeCanva-Center-100x100", new ResizeCanvas(100,100,ResizeOptions.Center),default(Rectangle) },
            { "ResizeCanva-UpperLeft-2000x2000", new ResizeCanvas(2000,2000),default(Rectangle) },
            { "ResizeCanva-Center-2000x2000", new ResizeCanvas(2000,2000,ResizeOptions.Center),default(Rectangle) },
